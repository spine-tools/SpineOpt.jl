    ...
    @testset "equal_investments" begin
        ...
        t4h = first(
            period__temporal_block__t(
                m; period=period(:window), temporal_block=temporal_block(:investments_four_hourly)
            )
        )
        ...
        node_c_inv_avail = [
            ...
            for t in period__temporal_block__t(
                m; period=period(:window), temporal_block=temporal_block(:investments_two_hourly)
            )
        ]
