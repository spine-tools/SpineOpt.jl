...
function test_unit_online_variable_type_none()
    @testset "unit_online_variable_type_none" begin
        ...
        @testset for (s, t) in zip(scenarios, time_slices)
            ...
            @test SpineOpt._get_units_on(m, key...) == number_of_units(unit=u)
    ...
    @testset "unit_online_variable_type_none_with_investments" begin
        ...
        object_parameter_values = [
            ...
            ["unit", "unit_ab", "number_of_units", 1],
        ]
        relationships = [
        ...
        @testset for (s, t) in zip(scenarios, time_slices)
            ...
            @test_throws KeyError var_units_on[key...]
            @test_throws KeyError constraint_u_avail[key...]
            @test SpineOpt._get_units_on(m, u, s, t) == var_units_invested_available[key...] + number_of_units(unit=u)
