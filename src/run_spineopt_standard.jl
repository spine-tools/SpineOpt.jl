...
function add_variables!(m; add_user_variables=m -> nothing, log_level=3)
    ...
    @timelog log_level 3 "- [variable_unit_flow_op_active]" add_variable_unit_flow_op_active!(m)
...
function add_constraints!(m; add_constraints=m -> nothing, log_level=3)
    ...
    @timelog log_level 3 "- [constraint_operating_point_rank]" add_constraint_operating_point_rank!(m)
    @timelog log_level 3 "- [constraint_unit_flow_op_bounds]" add_constraint_unit_flow_op_bounds!(m)
    @timelog log_level 3 "- [constraint_unit_flow_op_rank]" add_constraint_unit_flow_op_rank!(m)
    @timelog log_level 3 "- [constraint_unit_flow_op_sum]" add_constraint_unit_flow_op_sum!(m)
