...
function add_variables!(m; add_user_variables=m -> nothing, log_level=3)
    ...
    @timelog log_level 3 "- [variable_connections_invested_state]" add_variable_connections_invested_state!(m)
    @timelog log_level 3 "- [variable_connections_invested_state_vintage]" add_variable_connections_invested_state_vintage!(m)
