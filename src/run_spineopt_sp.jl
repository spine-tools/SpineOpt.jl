...
function add_variables!(m; add_user_variables=m -> nothing, log_level=3)
    ...
    @timelog log_level 3 "- [variable_nodes_invested]" add_variable_nodes_invested!(m)
    @timelog log_level 3 "- [variable_nodes_invested_available]" add_variable_nodes_invested_available!(m)
    @timelog log_level 3 "- [variable_nodes_decommissioned]" add_variable_nodes_decommissioned!(m)
...
function add_constraints!(m; add_constraints=m -> nothing, log_level=3)
    ...
    #     m,
    # )
    @timelog log_level 3 "- [constraint_nodes_invested_available]" add_constraint_nodes_invested_available!(m)
    @timelog log_level 3 "- [constraint_node_lifetime]" add_constraint_node_lifetime!(m)
