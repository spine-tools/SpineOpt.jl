"""
objective_minimize_production_cost:
This function represents the objective of the optimization problem
In this case the production_cost correspond to the sum over all 
