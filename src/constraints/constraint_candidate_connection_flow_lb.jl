...
this constraint ensures that [connection\_flow](@ref var_connection_flow) is zero if the candidate connection is not invested-in and
equals [connection\_intact\_flow](@ref var_connection_intact_flow) otherwise.
