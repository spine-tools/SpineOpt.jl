...
function add_constraint_unit_flow_capacity!(m::Model)
    ...
    m.ext[:constraints][:unit_flow_capacity] = Dict(
        (unit=u, node=ng, direction=d, stochastic_path=s, t=t) => @constraint(
            ...
            + expr_sum(
                (units_on[u, s, t1])
                * unit_capacity[(unit=u, node=ng, direction=d, stochastic_scenario=s, analysis_time=t0, t=t1)]
                * unit_conv_cap_to_flow[(unit=u, node=ng, direction=d, stochastic_scenario=s, analysis_time=t0, t=t1)]
