...
function _save_economic_parameter_values!(m::Model)
    ...
    m.ext[:spineopt].values[:unit_discounted_duration] = Dict()
    if use_economic_representation(model=m.ext[:spineopt].instance)
        if :unit_salvage_fraction in user_outputs
        ...
        if :unit_tech_discount_factor in user_outputs
            _populate_economic_parameter_values!(
                m,
        ...
        if :unit_conversion_to_discounted_annuities in user_outputs        
            _populate_economic_parameter_values!(
                m,
        ...
        if :unit_discounted_duration in user_outputs                
            _populate_economic_parameter_values!(
                m,
    ...
    m.ext[:spineopt].values[:connection_discounted_duration] = Dict()
    if use_economic_representation(model=m.ext[:spineopt].instance)
        ...
        if :connection_tech_discount_factor in user_outputs        
            _populate_economic_parameter_values!(
                m,
        ...
        if :connection_conversion_to_discounted_annuities in user_outputs        
            _populate_economic_parameter_values!(
                m,
        ...
        if :connection_discounted_duration in user_outputs                
            _populate_economic_parameter_values!(
                m,
    ...
    m.ext[:spineopt].values[:storage_discounted_duration] = Dict()
    if use_economic_representation(model=m.ext[:spineopt].instance)
        if :storage_salvage_fraction in user_outputs                
            _populate_economic_parameter_values!(
                m,
        ...
        if :storage_tech_discount_factor in user_outputs                
            _populate_economic_parameter_values!(
                m,
        ...
        if :storage_conversion_to_discounted_annuities in user_outputs                
            _populate_economic_parameter_values!(
                m,
        ...
        if :storage_discounted_duration in user_outputs                        
            _populate_economic_parameter_values!(
                m,
