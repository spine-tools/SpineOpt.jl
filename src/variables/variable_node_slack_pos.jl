...
for `node`, `s`, and `t`.
"""
function node_slack_indices(m::Model; node=anything, stochastic_scenario=anything, t=anything, temporal_block=temporal_block(representative_periods=nothing) )
