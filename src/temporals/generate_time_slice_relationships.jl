...
function generate_time_slice_relationships()
    ...
    t_before_t = RelationshipClass(:t_before_t, (:t_before, :t_after), NamedTuple(), t_before_t_list, [])
    t_in_t = RelationshipClass(:t_in_t, (:t_short, :t_long), NamedTuple(), t_in_t_list, [])
    t_in_t_excl = RelationshipClass(:t_in_t_excl, (:t_short, :t_long), NamedTuple(), t_in_t_excl_list, [])
