...
function add_variables!(m; log_level=3)
    ...
    @timelog log_level 3 "- [variable_candidate_connection_flow]" add_variable_candidate_connection_flow!(m)
...
function add_constraints!(m; add_constraints=m -> nothing, log_level=3)    
    ...
    @timelog log_level 3 "- [constraint_candidate_connection_flow_capacity]" add_constraint_candidate_connection_flow_capacity!(m)
    @timelog log_level 3 "- [constraint_candidate_connection_flow_base_flow]" add_constraint_candidate_connection_flow_base_flow!(m)
