...
function run_spinemodel(
    ...
    @logtime level2 "Adding constraints...\n" begin
        ...
        @logtime level3 "- [constraint_nodal_balance]" add_constraint_node_state_balance!(m)
        @logtime level3 "- [constraint_nodal_balance]" add_constraint_node_state_capacity!(m)
    ...
    while true
        ...
        @logtime level2 "Updating constraints...\n" begin
            ...
            @logtime level3 "- [constraint_nodal_balance]" update_constraint_node_state_balance!(m)
            @logtime level3 "- [constraint_nodal_balance]" update_constraint_node_state_capacity!(m)
