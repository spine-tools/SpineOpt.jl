...
function run_spinemodel(
    ...
    @logtime level2 "Adding constraints...\n" begin
        ...
        @logtime level3 "- [constraint_node_state_balance]" add_constraint_node_state_balance!(m)
    ...
    while true
        ...
        @logtime level2 "Updating constraints...\n" begin
            ...
            @logtime level3 "- [constraint_node_state_balance]" update_constraint_node_state_balance!(m)
            @logtime level3 "- [constraint_node_state_capacity]" update_constraint_node_state_capacity!(m)
