...
include("variables/variable_nonspin_res_up.jl")
include("variables/variable_start_up_ramp.jl")
include("variables/variable_ramp_up.jl")
...
include("constraints/constraint_max_start_up_ramps.jl")
include("constraints/constraint_min_start_up_ramps.jl")
#TODO: include("constraints/constraint_ramp_down.jl")
include("constraints/constraint_limit_export_brute_force.jl")
