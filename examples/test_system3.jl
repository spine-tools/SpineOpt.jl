...
db_url = "sqlite:///C:/Users/u0122387/Desktop/toolbox/projects/temporal_structure/input_timestorage/testsystem_temporals.sqlite"
JuMP_all_out(db_url)

# Create temporal_structure
(timeslices,durations,details) = time_slicemap()
timesliceblocks = time_slices_tempblock()
t_before_t = generate_t_before_t(timeslices,details)
