...
Also, imagine you have a [node](@ref) where the [demand](@ref) is a time-series defined as follows:
...
it updates the value of `t` by adding the [roll\_forward](@ref) value.
