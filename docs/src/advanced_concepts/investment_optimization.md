...
| `unit_investment_technical_lifetime` | `unit` | The investment lifetime of the `unit` - once invested-in, a `unit` must exist for at least this amount of time
...
| `connection_investment_technical_lifetime` | `connection` | The investment lifetime of the `connection` - once invested-in, a `connection` must exist for at least this amount of time
...
| `storage_investment_technical_lifetime` | `node` | The investment lifetime of the storage - once invested-in, a storage must exist for at least this amount of time
...
| constraint_unit_lifetime.jl | \constraints| once a `unit` is invested-in, it must remain in existence for at least `unit_investment_technical_lifetime` - analagous to `min_up_time`.
...
| constraint_connection_lifetime.jl | \constraints| once a `connection` is invested-in, it must remain in existence for at least `connection_investment_technical_lifetime` - analagous to `min_up_time`.
...
| constraint_storage_lifetime.jl | \constraints| once a storage is invested-in, it must remain in existence for at least `storage_investment_technical_lifetime` - analagous to `min_up_time`.
