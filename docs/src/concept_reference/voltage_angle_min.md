If a node has a [node\_voltage\_angle](@ref var_node_voltage_angle) variable (see also the parameter [physics\_type](@ref) and this [chapter](@ref Lossless-nodal-DC-power-flows)),
