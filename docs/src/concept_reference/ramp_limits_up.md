The definition of the [ramp\_limits\_up](@ref) parameter limits the maximum increase in the [unit\_flow](@ref var_unit_flow) over a period of time of one [duration\_unit](@ref) whenever the unit is online.
