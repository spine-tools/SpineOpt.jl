...
integer factors of the [capacity\_per\_connection](@ref) can be invested in. The value `variable_type_continuous` means that 
...
continuous, `investment_count_max_cumulative` is more analagous to a capacity with [capacity\_per\_unit](@ref) being 
