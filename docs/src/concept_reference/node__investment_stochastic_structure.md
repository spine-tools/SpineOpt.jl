...
Essentially, it sets the [stochastic\_structure](@ref) used by the [storages\_invested\_available](@ref var_storages_invested_available) variable of the [node](@ref).
