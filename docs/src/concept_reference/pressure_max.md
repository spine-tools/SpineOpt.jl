If a node has a [node\_pressure](@ref var_node_pressure) variable (see also the parameter [physics\_type](@ref) and this [chapter](@ref pressure-driven-gas-transfer)),
