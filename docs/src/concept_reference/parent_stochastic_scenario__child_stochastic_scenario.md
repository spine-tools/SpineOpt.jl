...
*stochastic direct acyclic graph (DAG)* in the [Stochastic Framework](@ref stochastic_framework) section.
...
See the [Stochastic Framework](@ref stochastic_framework) section for more information.