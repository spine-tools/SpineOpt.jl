The definition of the [max\_ratio\_out\_out\_unit\_flow](@ref) parameter triggers the generation of the
[constraint\_max\_ratio\_out\_out\_unit\_flow](@ref ratio_unit_flow) and sets an upper bound on the ratio between outgoing flows of a unit.
