The [stochastic\_structure](@ref) is the key component of the scenario-based [Stochastic Framework](@ref stochastic_framework)
...
[Stochastic Framework](@ref stochastic_framework) to the modelled system.
