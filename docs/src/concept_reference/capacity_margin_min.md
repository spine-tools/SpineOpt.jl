The parameter `capacity_margin_min` triggers the creation of a `capacity_margin_min` constraint which ensures
...
and for triggering unit investments due to capacity shortage. The `capacity_margin_min` constraint can be 
