The definition of the `ramp_down_limit` parameter limits the maximum decrease in the [unit\_flow](@ref) variable between two consecutive timesteps for which the unit is online.
