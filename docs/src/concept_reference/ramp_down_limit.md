The definition of the `ramp_down_limit` parameter limits the maximum decrease in the [unit\_flow](@ref) over a period of time of one [duration\_unit](@ref) whenever the unit is online.
