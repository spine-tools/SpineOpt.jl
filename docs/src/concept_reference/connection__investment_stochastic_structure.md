...
Essentially, it sets the [stochastic\_structure](@ref) used by the [connections\_invested\_available](@ref var_connections_invested_available) variable of the [connection](@ref).
