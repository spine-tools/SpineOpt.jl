...
In other words, it is the fix value of the [connections\_invested\_available](@ref var_connections_invested_available) variable.

Unit: The [investment\_count\_fix\_cumulative](@ref) parameter is used primarily to fix the value of the [units\_invested\_available](@ref var_units_invested_available)
