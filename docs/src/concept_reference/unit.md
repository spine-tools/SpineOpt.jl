...
The conversion ratio of input to output can be specified using any of [flow\_ratio\_equality\_coefficient](@ref),
[flow\_ratio\_less\_than\_coefficient](@ref), and [flow\_ratio\_greater\_than\_coefficient](@ref).
