The [fix\_shut\_down\_unit\_flow](@ref) parameter fixes the value of the [shut\_down\_unit\_flow](@ref Variables) to the provided value, if the parameter is defined.
