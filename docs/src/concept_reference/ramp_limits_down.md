The definition of the [ramp\_limits\_down](@ref) parameter limits the maximum decrease in the [unit\_flow](@ref var_unit_flow) over a period of time of one [duration\_unit](@ref) whenever the unit is online.
