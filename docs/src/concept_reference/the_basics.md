...
(with the exception of variable fixing parameters, e.g. [flow\_limits\_fix](@ref), [fix\_connection\_flow](@ref) etc.). See for instance [constraint\_unit\_flow\_capacity](@ref).
