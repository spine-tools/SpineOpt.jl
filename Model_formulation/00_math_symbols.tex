...
\newcommand{\pMaxTransCapa}[1][\connection]{p^{max.TransCapa}_{#1}}
\newcommand{\ptransloss}[1][\connection,\node_i,\node_j]{p^{loss}_{#1}}
\newcommand{\vTrans}[1][\connection,\node_i,\node_j,\timestep]{v^{Trans}_{#1}}
\newcommand{\vTranCapa}[1][\connection,\node_i,\node_j,\timestep]{v^{TransCapa}_{#1}}
\newcommand{\be}[1][\connection,\node_i,\node_j,\timestep]{\beta^{Trans}_{#1}}
\newcommand{\al}[1][\connection,\node_i,\node_j,\timestep]{\alpha^{Trans}_{#1}}
